import{a1 as r,_ as S,c as k,E as x,A as c,y as s,C as b,o as V,a as l}from"./chunks/framework.190a3809.js";const{defineComponent:N}=r,w=N({name:"component-doc",components:{"render-demo-0":function(){const{vModelText:u,createElementVNode:t,withDirectives:F,createTextVNode:d,resolveComponent:C,withCtx:m,createVNode:E,toDisplayString:a,Fragment:y,openBlock:_,createElementBlock:A}=r,D={style:{"margin-top":"16px"}};function v(o,n){const e=C("xl-button");return _(),A(y,null,[F(t("input",{class:"input",type:"text","onUpdate:modelValue":n[0]||(n[0]=p=>o.input=p)},null,512),[[u,o.input]]),E(e,{type:"primary",onClick:o.onSubmit},{default:m(()=>[d("提交")]),_:1},8,["onClick"]),t("div",D,"输出内容："+a(o.content),1)],64)}const{ref:B,defineComponent:i}=r,f=i({name:"InputDemo",setup(){const o=B(),n=B();function e(){n.value=o.value}return{input:o,content:n,onSubmit:e}}});return{render:v,...f}}(),"render-demo-1":function(){const{vModelText:u,createElementVNode:t,withDirectives:F,createTextVNode:d,resolveComponent:C,withCtx:m,createVNode:E,toDisplayString:a,Fragment:y,openBlock:_,createElementBlock:A}=r,D={style:{"margin-top":"16px"}};function v(o,n){const e=C("xl-button");return _(),A(y,null,[F(t("input",{class:"input",type:"text","onUpdate:modelValue":n[0]||(n[0]=p=>o.input=p)},null,512),[[u,o.input]]),E(e,{type:"primary",onClick:o.onSubmit},{default:m(()=>[d("提交")]),_:1},8,["onClick"]),t("div",D,"输出内容："+a(o.content),1)],64)}const{defineComponent:B}=r,{ref:i}=r;return{render:v,...B({setup(o,{expose:n}){n();const e=i(),p=i();function h(){p.value=e.value}const g={input:e,content:p,onSubmit:h,ref:i};return Object.defineProperty(g,"__isScriptSetup",{enumerable:!1,value:!0}),g}})}}()}}),G=JSON.parse('{"title":"Vue Script","description":"","frontmatter":{},"headers":[],"relativePath":"vue/vue-script.md","lastUpdated":1690336425000}');const T=s("h1",{id:"vue-script",tabindex:"-1"},"Vue Script",-1),I=s("h2",{id:"基础用法",tabindex:"-1"},"基础用法",-1),z=s("p",null,"基础的按钮用法。",-1),O=s("div",null,[l("使用 "),s("code",null,"type"),l("、"),s("code",null,"plain"),l("、"),s("code",null,"round"),l(" 和 "),s("code",null,"circle"),l(" 属性来定义 Button 的样式。")],-1),j=s("div",{class:"language-vue"},[s("pre",{"v-pre":"",class:"shiki github-dark vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#E1E4E8"}},"<"),s("span",{style:{color:"#85E89D"}},"template"),s("span",{style:{color:"#E1E4E8"}},">")]),l(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"}")]),l(`
`),s("span",{class:"line"},[s("span",{style:{color:"#24292E"}},"</"),s("span",{style:{color:"#22863A"}},"style"),s("span",{style:{color:"#24292E"}},">")]),l(`
`),s("span",{class:"line"})])])],-1);function J(u,t,F,d,C,m){const E=b("render-demo-0"),a=b("demo"),y=b("render-demo-1");return V(),k("div",null,[T,I,z,x(a,{customClass:"undefined",sourceCode:`<template>
...
`},{description:c(()=>[U]),highlight:c(()=>[P]),default:c(()=>[x(y)]),_:1})])}const H=S(w,[["render",J]]);export{G as __pageData,H as default};
